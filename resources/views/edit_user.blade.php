                            ...
                            <div class="table-responsive p-0">
                                ...
                                <form method="POST" action="{{route('add.user')}}" class="p-3">
                                    ...
                                    <div class="input-group input-group-outline mb-3">
                                        ...
                                        <input value="{{ $user->email }}" type="email"  class="form-control border-l-4 @error('email') is-invalid @enderror" name="email" >
                                        <div class="input-group input-group-outline mb-3">
                                    <span class="text-danger">
                                        @error('email')
                                        {{ $message }}
                                    ...
                                    <div class="input-group input-group-outline mb-3">
                                        ...
                                        <input value="{{$user->confirm_password}}" type="password" class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password"  >
                                        <div class="input-group input-group-outline mb-3">
                                    <span class="text-danger">
