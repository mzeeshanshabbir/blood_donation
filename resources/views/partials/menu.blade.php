        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->is('users')?'active':''}}" href="{{ route('show.user') }}">
                    ...
                    <span class="nav-link-text ms-1">Admin Users Table</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->is('donors')?'active':''}} " href="{{ route('show.donors') }}">
                    ...
                    <span class="nav-link-text ms-1">Donors Table</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->is('recipients')?'active':''}} " href="{{ route('show.recipients') }}">
                    ...
                    <span class="nav-link-text ms-1">Recipients Table</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->is('blood_type')?'active':''}}" href="{{ route('show.bloodtype') }}">
                    ...
                    <span class="nav-link-text ms-1">Blood Types Table</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->is('donations')?'active':''}} " href="{{ route('show.donations') }}">
                    ...
                    <span class="nav-link-text ms-1">Donations Table</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->is('donation_center')?'active':''}} " href="{{ route('show.donationcenter') }}">
                    ...
                    <span class="nav-link-text ms-1">Donation Centers Table</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  {{request()->is('donation_record')?'active':''}} " href="{{ route('show.donationrecord') }}">
                    ...
                    <span class="nav-link-text ms-1">Donation Records Table</span>
                </a>
            </li>
...
{{--            </li>--}}
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../pages/profile.html">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-red text-center me-2 d-flex align-items-center justify-content-center">
